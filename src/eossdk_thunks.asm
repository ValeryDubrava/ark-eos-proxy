...
g_thunkTargets QWORD 677 DUP(0)
...
PUBLIC EOS_SessionSearch_SetParameter
EOS_SessionSearch_SetParameter PROC
    jmp qword ptr [g_thunkTargets + 4672]
EOS_SessionSearch_SetParameter ENDP
...
EOS_UserInfo_Release PROC
    jmp qword ptr [g_thunkTargets + 5408]
